      ...
      >
        <div className="relative z-10 max-w-6xl w-full grid md:grid-cols-2 gap-12 glass p-10 md:p-14">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <p className="text-gray-300 leading-relaxed"> I’m a Computer Science Engineering student with strong fundamentals in Python and frontend development. I enjoy building clean, responsive interfaces and logic-driven applications. </p> 
